...
/**
 * Add Notes Activity
 * The activity for adding, editing or checking a note
 * Launched once add list is pressed in Notes Activity
 * or once a list is pressed from the Notes Activity recycler view
 */
public class AddNote extends AppCompatActivity {
    ...
    // Firebase
    /**
     * Saves note to database after checking for input errors
     */
