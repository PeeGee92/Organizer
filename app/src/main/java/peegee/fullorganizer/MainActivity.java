...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * Clear local lists for Firebase database
     */
    ...
    /**
     * Launch the authentication intent
     */
    private void authenticate() {
        ...
        // Create and launch sign-in activity
    ...
    /**
     * Handles the authentication intent results
     * <p>
     * @param requestCode the request code for the activity
     * @param resultCode contains the result of the intent
     * @param data contains the intent
     */
    @Override
    ...
    /**
     * Retrieve a new request code and increment the current value
     * <p>
     * @return the current request code available
     */
    ...
    /**
     * onClick generated by ButterKnife
     * <p>
