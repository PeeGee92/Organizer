...
/**
 * Add Alarm Activity
 * The activity for adding, editing or checking a alarm
 * Launched once add list is pressed in Alarm Activity
 * or once a list is pressed from the Alarm Activity recycler view
 */
public class AddAlarm extends AppCompatActivity {
    ...
    /**
     * Cancel old alarm and set a new one instead
     * <p>
     * @param alarmDB the alarm database item
     * @param calendar the calendar containing the alarm date and time
     ...
     * <p>
     * @param reminderDB the reminder database item
     * @param appContext the application context
     * @param alarmManager the alarm manager
     */
