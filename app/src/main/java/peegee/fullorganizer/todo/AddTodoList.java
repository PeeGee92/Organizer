...
/**
 * Add To-Do Activity
 * The activity for adding, editing or checking a to-do list
 * Launched once add list is pressed in To-Do List Activity
 * or once a list is pressed from the To-Do List Activity recycler view
 */
public class AddTodoList extends AppCompatActivity {
    ...
    /**
     * Check for input errors then save the list to database
     * and doing the appropriate actions for saving
     */
